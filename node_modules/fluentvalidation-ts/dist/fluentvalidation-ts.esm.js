...
var ExclusiveBetweenRule = /*#__PURE__*/function (_Rule) {
  ...
  function ExclusiveBetweenRule(lowerBound, upperBound) {
    return _Rule.call(this, function (value) {
      ...
      return value > lowerBound && value < upperBound ? null : "Value must be between " + formatNumber(lowerBound) + " and " + formatNumber(upperBound) + " (exclusive)";
    }) || this;
  }
...
var InclusiveBetweenRule = /*#__PURE__*/function (_Rule) {
  ...
  function InclusiveBetweenRule(lowerBound, upperBound) {
    return _Rule.call(this, function (value) {
      ...
      return value >= lowerBound && value <= upperBound ? null : "Value must be between " + formatNumber(lowerBound) + " and " + formatNumber(upperBound) + " (inclusive)";
    }) || this;
  }
...
var LengthRule = /*#__PURE__*/function (_Rule) {
  ...
  function LengthRule(minLength, maxLength) {
    return _Rule.call(this, function (value) {
      ...
      return value.length >= minLength && value.length <= maxLength ? null : "Value must be between " + formatNumber(minLength) + " and " + formatNumber(maxLength) + " characters long";
    }) || this;
  }
...
var MaxLengthRule = /*#__PURE__*/function (_Rule) {
  ...
  function MaxLengthRule(maxLength) {
    return _Rule.call(this, function (value) {
      ...
      return value.length <= maxLength ? null : "Value must be no more than " + formatNumber(maxLength) + " characters long";
    }) || this;
  }
...
var MinLengthRule = /*#__PURE__*/function (_Rule) {
  ...
  function MinLengthRule(minLength) {
    return _Rule.call(this, function (value) {
      ...
      return value.length >= minLength ? null : "Value must be at least " + formatNumber(minLength) + " characters long";
    }) || this;
  }
...
var CoreValueValidatorBuilder = function CoreValueValidatorBuilder(rebuildValidate, transformValue) {
  var _this = this;
...
var AsyncValueValidatorBuilder = /*#__PURE__*/function (_CoreValueValidatorBu) {
  ...
  function AsyncValueValidatorBuilder(rebuildValidateAsync, transformValue) {
    var _this;

    _this = _CoreValueValidatorBu.call(this, rebuildValidateAsync, transformValue) || this;

    _this.build = function () {
      return /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(value, model) {
          var transformedValue, _iterator, _step, rule, validationResult;

          return runtime_1.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  transformedValue = _this.transformValue(value);
                ...
                case 2:
                  ...
                  _context.next = 7;
                  return rule.rule.validateAsync(transformedValue, model);
                ...
                case 10:
                  _context.t0 = rule.rule.validate(transformedValue, model);
...
var AsyncArrayValueValidatorBuilder = function AsyncArrayValueValidatorBuilder(rebuildValidateAsync, propertyName, transformValue) {
  var _this = this;
  ...
  this.eachAsyncValueValidatorBuilder = new AsyncValueValidatorBuilder(rebuildValidateAsync, transformValue);
...
var ValueValidatorBuilder = /*#__PURE__*/function (_CoreValueValidatorBu) {
  ...
  function ValueValidatorBuilder(rebuildValidate, transformValue) {
    var _this;

    _this = _CoreValueValidatorBu.call(this, rebuildValidate, transformValue) || this;

    _this.build = function () {
      return function (value, model) {
        var transformedValue = _this.transformValue(value);

        for (var _iterator = _createForOfIteratorHelperLoose(_this.rules), _step; !(_step = _iterator()).done;) {
          var rule = _step.value;
          var validationResult = rule.rule.validate(transformedValue, model);
...
var ArrayValueValidatorBuilder = function ArrayValueValidatorBuilder(rebuildValidate, propertyName, transformValue) {
  var _this = this;

  this.build = function () {
    return function (value, model) {
      if (value == null || model[_this.propertyName] == null) {
        return null;
      }
  ...
  this.eachValueValidatorBuilder = new ValueValidatorBuilder(rebuildValidate, transformValue);
  this.propertyName = propertyName;
};
...
var CoreValidator = function CoreValidator(isAsync) {
  ...
  this.ruleFor = function (propertyName) {
    if (_this._isAsync) {
      var asyncValueValidatorBuilder = new AsyncValueValidatorBuilder(_this.rebuildValidateAsync, function (value) {
        return value;
      });
      ...
      var valueValidatorBuilder = new ValueValidatorBuilder(_this.rebuildValidate, function (value) {
        return value;
      });
  ...
  this.ruleForTransformed = function (propertyName, transformValue) {
    if (_this._isAsync) {
      var asyncValueValidatorBuilder = new AsyncValueValidatorBuilder(_this.rebuildValidateAsync, transformValue);
      _this.asyncValueValidatorBuildersByPropertyName[propertyName] = _this.asyncValueValidatorBuildersByPropertyName[propertyName] || [];

      _this.asyncValueValidatorBuildersByPropertyName[propertyName].push(asyncValueValidatorBuilder // Appease the type system
      );

      return asyncValueValidatorBuilder.getAllRules(); // Appease the type system
    } else {
      var valueValidatorBuilder = new ValueValidatorBuilder(_this.rebuildValidate, transformValue);
      _this.valueValidatorBuildersByPropertyName[propertyName] = _this.valueValidatorBuildersByPropertyName[propertyName] || [];
  ...
  this.ruleForEach = function (propertyName) {
    if (_this._isAsync) {
      var asyncArrayValueValidatorBuilder = new AsyncArrayValueValidatorBuilder(_this.rebuildValidateAsync, propertyName, function (value) {
        return value;
      });
      ...
      var arrayValueValidatorBuilder = new ArrayValueValidatorBuilder(_this.rebuildValidate, propertyName, function (value) {
        return value;
      });
  ...
  this.ruleForEachTransformed = function (propertyName, transformValue) {
    if (_this._isAsync) {
      var asyncArrayValueValidatorBuilder = new AsyncArrayValueValidatorBuilder(_this.rebuildValidateAsync, propertyName, transformValue);
      ...
      var arrayValueValidatorBuilder = new ArrayValueValidatorBuilder(_this.rebuildValidate, propertyName, transformValue // Appease the type system
      );
