...
module.exports = function writeDeploymentManifest(appDir, build) {
  const dest = join(appDir, '.edgio', DEPLOYMENT_MANIFEST_FILE);

  // Note: I realize I could just write the build objeect verbatim and that I'm not even changing the names
