...
module.exports = function resolveInPackage(pkg, ...file) {
  ...
  const path = resolvePackagePath(pkg, __dirname) || resolvePackagePath(pkg, process.cwd());
  // ^^ the second call to resolvePackagePath above is needed to resolve from packages
