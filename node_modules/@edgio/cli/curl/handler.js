...
async function handler(userCurlArgs, internalArgs, {
  ...
  logger.debug('');
  const curlResponse = await _Curl.default.run(userCurlArgs, internalArgs);

  // Returning early for json output since everything forward is only for making it look good in terminal
