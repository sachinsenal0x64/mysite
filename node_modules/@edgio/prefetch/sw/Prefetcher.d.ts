...
/**
 * Handles prefetching and caching in the service worker. Responses
 * are cached based on the `service_worker_max_age` feature
 * or equivalent `browser.serviceWorkerSeconds` cache setting in your rules.
 *
 * **Example routes.js**
 *
 * ```js
...
export default class Prefetcher {
     ...
     * cache if the route has `service_worker_max_age' feature defined or if the request is a prefetch.
     */
    route(): this;
