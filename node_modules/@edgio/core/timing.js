...
exports.CacheValue = exports.InternalNames = exports.addTimings = exports.getInternalTiming = exports.withTimings = exports.InternalTiming = exports.NOT_ENDED_VALUE = void 0;
...
function withTimings(handler) {
    return (...args) => {
        return (0, context_1.withContext)(() => {
            return handler(...args);
        });
    };
}
...
function internalTimings() {
    return (0, context_1.get)('internalTimings', []);
}
/**
...
function userTimings() {
    return (0, context_1.get)('userTimings', []);
}
/**
...
function addTimings(response) {
    ...
    if (userT.length) {
        response.setHeader(constants_1.HTTP_HEADERS.xEdgeUserT, getTimingsResponseHeader(userT));
        response.setHeader(constants_1.HTTP_HEADERS.serverTiming, appendServerTimings(response));
    }
    if (internalT.length) {
        response.setHeader(constants_1.HTTP_HEADERS.xEdgeT, getTimingsResponseHeader(internalT));
    }
}
