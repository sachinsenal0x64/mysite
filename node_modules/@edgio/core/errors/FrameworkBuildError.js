...
class FrameworkBuildError extends Error {
    constructor(framework, command, error) {
        super(`${framework} build command "${command}" failed. This is most likely due to an error in your application code and not a problem with Edgio. Try running "${command}" on your CLI`); // istanbul ignore next - this is a known issue with TypeScript
